...
const getAngularRoot = ({ failBuild, netlifyConfig }) => {
  ...
  if (
    ...
    if (!existsSync(path.join(angularRoot, 'angular.json'))) {
      return failBuild(`Could not locate your angular.json at ${process.cwd()} or ${angularRoot}. 
        Make sure your publish directory is set to {PATH_TO_YOUR_SITE}/dist/{YOUR_PROJECT_NAME}/browser, where
        YOUR_PROJECT_NAME is defaultProject in your angular.json.
      `)
    }
  }
  return angularRoot
